				...
				{sections.map((section) => (
					...
					>
						<div className='relative ml-10 w-2 h-24 bg-zinc-300 shadow-sm rounded-full transition-all group-hover:translate-x-4'>
							...
							/>
							<span className='absolute w-48 pointer-events-none top-1/2 -translate-y-1/2 left-full ml-2 text-gray-800 max-w-xs break-words opacity-0 group-hover:opacity-100 -translate-x-2 group-hover:translate-x-2 transition-all duration-300'>
