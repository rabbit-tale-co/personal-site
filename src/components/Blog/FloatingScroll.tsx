...
const FloatingScroll = () => {
	...
	return (
		<div className='hidden md:fixed md:left-0 md:top-1/2 md:transform md:-translate-y-1/2 md:z-10 md:flex md:flex-col md:items-center md:space-y-2'>
			{/* Overlay */}
			...
			{sections.map((section) => (
				...
				>
					<div className='relative ml-10 transition-all group-hover:translate-x-4'>
						...
						<span className='absolute w-48 pointer-events-none top-1/2 -translate-y-1/2 left-full ml-2 font-bold  capitalize text-gray-900 max-w-xs break-words opacity-0 group-hover:opacity-100 -translate-x-10 blur-lg group-hover:blur-0 group-hover:translate-x-2 transition-all duration-300'>
