...
const Tooltip = (props: {
	...
	return (
		<div
			className={cn(
				'pointer-events-none absolute hidden w-max rounded-lg bg-zinc-900 px-2.5 py-1 text-sm text-zinc-300 opacity-0 shadow-lg transition dark:bg-white sm:flex sm:group-hover/tooltip:opacity-100',
				{
